...
- `papu_san_chesscom_data.json` (~176 Ko), `papu_san_chesscom_data.csv` (~61 Ko) — non versionnés (backup via Google Drive).
...
- Rapport détaillé : `_rapports/rapport_2026-09-04-donnees-premium-chesscom.txt`.
